...
```text
  version    0.45.0            tests       1509 across 60 files
  released   51 versions       coverage    97.12% lines, CI-enforced floor
  built      2026-06 to now    source      45 modules, 16.5k lines
  license    MIT               test code   23.2k lines
```
...
| | |
|---|---|
| **Tests** | 1509 across 60 files. 23.2k lines of test code against 16.5k of source. |
